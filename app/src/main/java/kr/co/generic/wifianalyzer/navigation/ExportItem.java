...
class ExportItem implements NavigationMenuItem {
    ...
    public void activate(@NonNull MainActivity mainActivity, @NonNull MenuItem menuItem, @NonNull NavigationMenu navigationMenu) {
        ...
        if (!dataAvailable(wiFiDetails)) {
            Toast.makeText(mainActivity, kr.co.generic.wifianalyzer.R.string.no_data, Toast.LENGTH_LONG).show();
            return;
        }
        ...
        if (!exportAvailable(mainActivity, chooser)) {
            Toast.makeText(mainActivity, kr.co.generic.wifianalyzer.R.string.export_not_available, Toast.LENGTH_LONG).show();
            return;
        }
    ...
    private String getTitle(@NonNull MainActivity mainActivity) {
        ...
        return resources.getString(kr.co.generic.wifianalyzer.R.string.action_access_points);
    }
