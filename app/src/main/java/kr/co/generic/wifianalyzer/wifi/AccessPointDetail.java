...
import kr.co.generic.wifianalyzer.wifi.model.Security;
...
public class AccessPointDetail {
    ...
    View makeView(View convertView, ViewGroup parent, @NonNull WiFiDetail wiFiDetail, boolean isChild) {
        ...
        if (view.findViewById(kr.co.generic.wifianalyzer.R.id.capabilities) != null) {
    ...
    private void setViewCompact(@NonNull Context context, @NonNull View view, @NonNull WiFiDetail wiFiDetail, boolean isChild) {
        ...
        securityImage.setColorFilter(ContextCompat.getColor(context, kr.co.generic.wifianalyzer.R.color.icons_color));
        ...
        ((TextView) view.findViewById(kr.co.generic.wifianalyzer.R.id.primaryFrequency))
    ...
    private void setViewExtra(@NonNull Context context, @NonNull View view, @NonNull WiFiDetail wiFiDetail) {
        ...
        if (wiFiAdditional.isConfiguredNetwork()) {
            ...
            configuredImage.setColorFilter(ContextCompat.getColor(context, kr.co.generic.wifianalyzer.R.color.connected));
        } else {
    ...
    private void setViewVendorShort(@NonNull View view, @NonNull WiFiAdditional wiFiAdditional) {
        TextView textVendorShort = ((TextView) view.findViewById(kr.co.generic.wifianalyzer.R.id.vendorShort));
