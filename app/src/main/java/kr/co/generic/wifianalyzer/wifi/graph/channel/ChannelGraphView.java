...
import kr.jjoe64.graphview.series.TitleLineGraphSeries;
...
import kr.co.generic.wifianalyzer.wifi.band.WiFiChannels;
import kr.co.generic.wifianalyzer.wifi.graph.tools.GraphColor;
...
class ChannelGraphView implements GraphViewNotifier {
    ...
    private GraphView makeGraphView() {
        ...
        return new GraphViewBuilder(mainActivity, getNumX())
            ...
            .setVerticalTitle(resources.getString(kr.co.generic.wifianalyzer.R.string.graph_axis_y))
            .setHorizontalTitle(resources.getString(kr.co.generic.wifianalyzer.R.string.graph_channel_axis_x))
            .build();
    }
