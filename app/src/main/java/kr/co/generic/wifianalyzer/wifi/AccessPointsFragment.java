...
public class AccessPointsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        swipeRefreshLayout = (SwipeRefreshLayout) view.findViewById(kr.co.generic.wifianalyzer.R.id.accessPointsRefresh);
        swipeRefreshLayout.setOnRefreshListener(new ListViewOnRefreshListener());

        accessPointsAdapter = new AccessPointsAdapter(activity);
        ExpandableListView expandableListView = (ExpandableListView) view.findViewById(kr.co.generic.wifianalyzer.R.id.accessPointsView);
