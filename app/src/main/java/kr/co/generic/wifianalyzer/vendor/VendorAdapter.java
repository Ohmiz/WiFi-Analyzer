...
package kr.co.generic.wifianalyzer.vendor;
...
class VendorAdapter extends ArrayAdapter<String> {
    ...
    VendorAdapter(@NonNull Context context, @NonNull SortedMap<String, List<String>> vendors) {
        super(context, kr.co.generic.wifianalyzer.R.layout.vendor_details, new ArrayList<>(vendors.keySet()));
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (view == null) {
            ...
            view = layoutInflater.inflate(kr.co.generic.wifianalyzer.R.layout.vendor_details, parent, false);
        }
        String name = getItem(position);
        ((TextView) view.findViewById(kr.co.generic.wifianalyzer.R.id.vendor_name)).setText(name);
        ...
        ((TextView) view.findViewById(kr.co.generic.wifianalyzer.R.id.vendor_macs)).setText(stringBuilder.toString());
        return view;
    }
