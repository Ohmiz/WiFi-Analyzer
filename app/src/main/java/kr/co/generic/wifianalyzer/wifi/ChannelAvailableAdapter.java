...
import kr.co.generic.wifianalyzer.wifi.band.WiFiChannelCountry;
...
class ChannelAvailableAdapter extends ArrayAdapter<WiFiChannelCountry> {
    ChannelAvailableAdapter(@NonNull Context context, @NonNull List<WiFiChannelCountry> wiFiChannelCountries) {
        super(context, kr.co.generic.wifianalyzer.R.layout.channel_available_details, wiFiChannelCountries);
    }
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (view == null) {
            ...
            view = layoutInflater.inflate(kr.co.generic.wifianalyzer.R.layout.channel_available_details, parent, false);
        }
