...
class ChannelGraphNavigation {
    ...
    private void setSelectedButton(Button button, boolean selected) {
        if (selected) {
            button.setBackgroundColor(ContextCompat.getColor(context, kr.co.generic.wifianalyzer.R.color.connected));
            button.setSelected(true);
        } else {
            button.setBackgroundColor(ContextCompat.getColor(context, kr.co.generic.wifianalyzer.R.color.connected_background));
