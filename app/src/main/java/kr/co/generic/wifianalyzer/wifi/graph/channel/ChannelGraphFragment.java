...
import kr.co.generic.wifianalyzer.Configuration;
import kr.co.generic.wifianalyzer.MainContext;
import kr.co.generic.wifianalyzer.wifi.graph.channel.ChannelGraphNavigation.NavigationItem;
import kr.co.generic.wifianalyzer.wifi.scanner.Scanner;
...
public class ChannelGraphFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(kr.co.generic.wifianalyzer.R.layout.graph_content, container, false);

        swipeRefreshLayout = (SwipeRefreshLayout) view.findViewById(kr.co.generic.wifianalyzer.R.id.graphRefresh);
    ...
    private void addGraphNavigation(View view, ChannelGraphNavigation channelGraphNavigation) {
        LinearLayout linearLayout = (LinearLayout) view.findViewById(kr.co.generic.wifianalyzer.R.id.graphNavigation);
    ...
    private void addGraphViews(View view, ChannelGraphAdapter channelGraphAdapter) {
        ViewFlipper viewFlipper = (ViewFlipper) view.findViewById(kr.co.generic.wifianalyzer.R.id.graphFlipper);
