...
class AccessPointsAdapter extends BaseExpandableListAdapter implements UpdateNotifier {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (childrenCount > 0) {
            ...
            groupIndicator.setImageResource(isExpanded
                ? kr.co.generic.wifianalyzer.R.drawable.ic_expand_less_black_24dp
                : kr.co.generic.wifianalyzer.R.drawable.ic_expand_more_black_24dp);
            groupIndicator.setColorFilter(ContextCompat.getColor(context, kr.co.generic.wifianalyzer.R.color.icons_color));
        } else {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        attachPopup(view, wiFiDetail);
        view.findViewById(kr.co.generic.wifianalyzer.R.id.groupIndicator).setVisibility(View.GONE);
        return view;
    }
    ...
    private void attachPopup(@NonNull View view, @NonNull WiFiDetail wiFiDetail) {
        View popupView = view.findViewById(kr.co.generic.wifianalyzer.R.id.attachPopup);
        if (popupView != null) {
            accessPointPopup.attach(popupView, wiFiDetail);
            accessPointPopup.attach(view.findViewById(kr.co.generic.wifianalyzer.R.id.ssid), wiFiDetail);
        }
    }
}
