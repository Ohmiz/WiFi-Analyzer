...
import kr.co.generic.wifianalyzer.GenericAdActivity;
...
import kr.co.generic.wifianalyzer.settings.SettingActivity;
import kr.co.generic.wifianalyzer.vendor.VendorFragment;
import kr.co.generic.wifianalyzer.wifi.AccessPointsFragment;
import kr.co.generic.wifianalyzer.wifi.ChannelAvailableFragment;
import kr.co.generic.wifianalyzer.wifi.ChannelRatingFragment;
import kr.co.generic.wifianalyzer.wifi.graph.channel.ChannelGraphFragment;
import kr.co.generic.wifianalyzer.wifi.graph.time.TimeGraphFragment;
...
public enum NavigationMenu {
    ...
    RECOMMEND(R.drawable.ic_info_outline_grey_500_48dp, R.string.action_recommend, new ActivityItem(GenericAdActivity.class)),
