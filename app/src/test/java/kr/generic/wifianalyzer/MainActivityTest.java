...
import kr.co.generic.wifianalyzer.navigation.NavigationMenuView;
import kr.co.generic.wifianalyzer.settings.ThemeStyle;
import kr.co.generic.wifianalyzer.wifi.AccessPointView;
...
public class MainActivityTest {
    ...
    public void testClickingOnToolbarTogglesWiFiBand() throws Exception {
        ...
        // execute & validate
        Assert.assertEquals(NavigationMenu.ACCESS_POINTS, fixture.getNavigationMenuView().getCurrentNavigationMenu());
    ...
    public void testShouldNotReloadWithNoAccessPointViewChanges() throws Exception {
        ...
        // execute && validate
        assertFalse(fixture.shouldReload());
        Assert.assertEquals(expected, fixture.getCurrentAccessPointView());
    }
