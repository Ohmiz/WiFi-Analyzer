...
import kr.co.generic.wifianalyzer.wifi.model.GroupBy;
...
public class AccessPointsAdapterDataTest {
    ...
    public void testBeforeUpdate() throws Exception {
        ...
        Assert.assertEquals(WiFiDetail.EMPTY, fixture.parent(0));
        Assert.assertEquals(WiFiDetail.EMPTY, fixture.parent(-1));
        Assert.assertEquals(WiFiDetail.EMPTY, fixture.child(0, 0));
        Assert.assertEquals(WiFiDetail.EMPTY, fixture.child(0, -1));
    }
    ...
    public void testAfterUpdate() throws Exception {
        ...
        Assert.assertEquals(wiFiDetails.get(0), fixture.parent(0));
        assertEquals(wiFiDetails.get(0).getChildren().size(), fixture.childrenCount(0));
        Assert.assertEquals(wiFiDetails.get(0).getChildren().get(0), fixture.child(0, 0));

        Assert.assertEquals(WiFiDetail.EMPTY, fixture.parent(-1));
        Assert.assertEquals(WiFiDetail.EMPTY, fixture.parent(wiFiDetails.size()));
        Assert.assertEquals(WiFiDetail.EMPTY, fixture.child(0, -1));
        Assert.assertEquals(WiFiDetail.EMPTY, fixture.child(0, wiFiDetails.get(0).getChildren().size()));
    }
