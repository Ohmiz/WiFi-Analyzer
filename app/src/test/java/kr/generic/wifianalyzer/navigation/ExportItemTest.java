...
public class ExportItemTest {
    ...
    private void withResources() {
        ...
        when(resources.getString(kr.co.generic.wifianalyzer.R.string.action_access_points)).thenReturn(sendTitle);
    }

    private void verifyResources() {
        verify(mainActivity).getResources();
        verify(resources).getString(kr.co.generic.wifianalyzer.R.string.action_access_points);
    }
